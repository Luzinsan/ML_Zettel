Регрессия опорных векторов - это метод (от SVM - [[Support Vector Machine - SVM]]), который пытается найти функцию, наилучшим образом предсказывающую непрерывные целевые переменные для поданного входа.
